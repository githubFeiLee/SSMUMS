...
<body>
	<div id="topLogoPanel">
		<div class="top-logo-panel">
			...
			<div class="form select-language-panel">
				<div class="form-group">
					<select
						class="select-content select-content-btn select-language-btn">
						<option value="zh_CN"
		...
		<div class="bottom-content-panel">
			<div class="left-menu-panel">
				<ul class="menu-item-list">
					<li class="active menu-item" data-url="/user/manage/list"><a
						href="javascript:;"><spring:message code="menu.user" /></a></li>
					<li class="menu-item" data-url="/role/manage/list"><a
						href="javascript:;"> <spring:message code="menu.role" />
					</a></li>
					<li class="menu-item" data-url="/jurisdiction/manage/list"><a
						href="javascript:;"> <spring:message code="menu.jurisdiction" />
					</a></li>
					<li class="menu-item" data-url="/department/manage/list"><a
						href="javascript:;"> <spring:message code="menu.department" />
					</a></li>
				</ul>
			</div>
